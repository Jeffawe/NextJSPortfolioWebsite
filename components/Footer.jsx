...
const Footer = () => {
  return (
    <div className='bg-black w-screen md:p-20 p-10 py-20' id='contact'>
        <div className='items-center pb-0 justify-center w-full'>
        ...
        <div className='pt-8 select-all w-full'>
          <p className='text-white font-normal text-base md:text-xl text-center'>awagujeffery@gmail.com</p>
        </div>
